...
// controlel'increment ne doit pas etre superieur au nombre de video
if ($ar_channel_info[5] < $incrementby) $incrementby = $ar_channel_info[5];
...
<span class="'.$class_sty_1.'">'.video_yt_translate('Vid&#xE9;oth&#xE8;que de').' '.$account.'</span>&nbsp;&nbsp;<a href="http://gdata.youtube.com/feeds/api/users/'.$account.'/uploads" target="blank"><img src ="modules/'.$ModPath.'/images/standard_rss.png" alt="icone rss" border="0" /></a></p>
<p class="yt_title">
...
<span class="'.$class_sty_2.'">'.video_yt_translate('vues').' </span>, '.$ar_channel_info[5].' <span class="'.$class_sty_2.'">'.video_yt_translate('vid&#xE9;os').'.</span>
</p>
...
<div id="yt_ent" style="display: block;">
 <div id="videos2"></div>
 <div id="yt_navbloc"> <span class="yt_soustitre">'.video_yt_translate('Vid&#xE9;os').'</span> 1 <span class="yt_soustitre">'.video_yt_translate('&#xE0;').'</span> '.$incrementby.' <span class="yt_soustitre">'.video_yt_translate('total').' :</span> '.$ar_channel_info[5];

if ($total_found > $incrementby) { $ent_affi .= 
'&nbsp;&nbsp;<a class="e" href=" javascript:yt.appendScriptTag(\'http://gdata.youtube.com/feeds/api/\',\'\',\'\',\'showMyVideos2\',\'jsonscript\','.($incrementby+1).','.$incrementby.',\'&amp;author='.$account.'\',\'flyingscript\')">['.video_yt_translate('Suivantes').']</a><a class="e" href="javascript:yt.appendScriptTag(\'http://gdata.youtube.com/feeds/api/\',\'\',\'\',\'showMyVideos2\',\'jsonscript\',\'20\',\'7\',\'&amp;author='.$account.'\',\'flyingscript\')">['.video_yt_translate('Derni&#xE8;res').']</a>';}
...
<table>
 <tbody>
  <tr>
   <td id="media_video">
    <div id="yt_playercontainer">';
//==> a debbuger utilisation pour safari
/*
echo'       <object id="main_FlashContent" name="main_FlashContent" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="'.$video_width.'" height="'.$video_height.'" id="main_FlashContent">
    <param id= "yt_movie_ie" name="movie" />
    <param name="play" value="false" />
    <param name="allowfullscreen" value="true" />
    <!--[if !IE]>-->
    <object id="yt_movie" name="main_FlashContent" type="application/x-shockwave-flash" width="'.$video_width.'" height="'.$video_height.'">
     <param name="play" value="false" />
     <param name="allowfullscreen" value="true" />
    <!--<![endif]-->
...
<script id="param_conf" type="text/javascript">yt.myaccount=\''.$account.'\';yt.rep_account=\''.$rep_account.'\';yt.mr='.$incrementby.';yt.msr='.$search_incrementby.';yt.h_vi='.$video_height.';yt.w_vi='.$video_width.';yt.lang=\''.$user_language.'\';'.$new_file_lang.'</script>
<div id="flyingscript_2"><script type="text/javascript"></script></div>
...
<div id="flyingscript"><script type="text/javascript" id="jsonscript" src="http://gdata.youtube.com/feeds/api/videos?alt=json-in-script&amp;callback=showMyVideos2&amp;start-index=1&amp;max-results='.$incrementby.'&amp;author='.$account.'"></script></div>
';
