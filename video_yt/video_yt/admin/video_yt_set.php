...
function ConfigureVideo($ModPath, $ModStart, $class_sty_2) {
   ...
   <td width="25%">
   <span class="'.$class_sty_2.'">'.video_yt_translate('Votre ID developpeur youtube').'</span> </td><td><input type="text" size="33" maxlength="255" name="dev_id" value="'.$dev_id.'"></td></tr><tr><td width="25%">
...
function SaveSetVideo_yt($dev_id, $dev_key, $account, $rep_account, $incrementby, $video_width, $video_height, $bloc_width, $bloc_height, $search_incrementby, $bg_yt_search, $class_sty_1, $class_sty_2, $class_sty_3, $ModPath, $ModStart) {
...
echo $content;
   function AfterSaveSetVideo_yt($dev_id, $dev_key, $account, $rep_account, $incrementby, $video_width, $video_height,$bloc_width, $bloc_height, $search_incrementby, $bg_yt_search, $class_sty_1, $class_sty_2, $class_sty_3, $ModPath, $ModStart) {
...
if ($admin) {
   ...
   switch ($subop) {
       ...
       SaveSetVideo_yt($dev_id, $dev_key, $account, $rep_account, $incrementby, $video_width, $video_height, $bloc_width, $bloc_height, $search_incrementby, $bg_yt_search, $class_sty_1, $class_sty_2, $class_sty_3, $ModPath, $ModStart);
       case "AfterSaveSetVideo_yt":
       AfterSaveSetVideo_yt($dev_id, $dev_key, $account, $rep_account, $incrementby, $video_width, $video_height, $bloc_width, $bloc_height, $search_incrementby, $bg_yt_search, $class_sty_1, $class_sty_2, $class_sty_3, $ModPath, $ModStart);
       default:
