...
function ag_translate($phrase) {
 switch ($phrase) {
   ...
   case "Ajout + Groupe": $tmp = "Adición + Grupo"; break;
   case "Ajout d'événement : 1 Tous les membres - ou groupe": $tmp = "La adición de evento: Todos los miembros - o grupo"; break;
   ...
   case "Cet évènement est mis à jour": $tmp = "Este evento se actualiza"; break;
   ...
   case "Editer un évènement": $tmp = "Editar un evento"; break;
   ...
   case "Etes-vous certain de vouloir supprimer cet évènement": $tmp = "¿Está seguro de que desea eliminar este evento?"; break;
   case "Etre averti par mail d'un nouvel evenement": $tmp = "Ser informado por correo electrónico de nuevos eventos"; break;
   case "Evènement": $tmp = "Evento"; break;
   case "Evènement(s) à venir": $tmp = "Evento próximo"; break;
   case "Evènement(s) en cours ou passé(s)": $tmp = "Eventos o pasado actuales"; break;
   case "Evènement nouveau dans agenda": $tmp = "Nuevos eventos en el calendario"; break;
   ...
   case "Jour avec évènement(s)": $tmp = "Evento de un día con"; break;
   ...
   case "Liste des évènements": $tmp = "Lista de eventos"; break;
   case "Liste de vos évènements": $tmp = "Lista de sus eventos"; break;
   ...
   case "Mai": $tmp = "Mayo"; break;
   case "Mail du receveur": $tmp = "Destinatario de correo"; break;
   ...
   case "Modification évènement pour agenda": $tmp = "La agenda de actividades para el cambio"; break;
   case "Modifier l'Evènement": $tmp = "Editar Evento"; break;
   case "Modifier la catégorie": $tmp = "Cambio de categoría"; break;
   case "Nbre d'évènements (pagination)": $tmp = "Número de eventos"; break;
   case "Dans la partie module": $tmp = "En la parte del módulo"; break;
   case "Dans la partie admin": $tmp = "En la administración parte"; break;
   ...
   case "Proposer évènement": $tmp = "Enviar un evento"; break;
   case "Proposer un évènement": $tmp = "Enviar un evento"; break;
   ...
   case "Résumé de l'évènement": $tmp = "Resumen del evento"; break;
   ...
   case "Sélectionner si nécessaire": $tmp = "Seleccione si es necesario"; break;
   ...
   case "Supprimer cet évènement": $tmp = "Eliminar este evento"; break;
   ...
   case "Un évènement nouveau est à valider dans agenda": $tmp = "Un nuevo evento es validar en la agenda"; break;
   case "V": $tmp = "V"; break;
