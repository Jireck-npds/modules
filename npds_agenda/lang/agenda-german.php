...
function ag_translate($phrase) {
   ...
   case "Ajout + Groupe": $tmp = "Hinzufügen + Group"; break;
   case "Ajout d'événement : 1 Tous les membres - ou groupe": $tmp = "Hinzufügen Ereignis: 1 Alle Mitglieder - oder Gruppe"; break;
   ...
   case "Cet évènement est maintenant effacé": $tmp = "Dieses Ereignis wurde nun gelöscht worden"; break;
   case "Cet évènement est mis à jour": $tmp = "Dieses Ereignis wird aktualisiert"; break;
   ...
   case "Editer un évènement": $tmp = "Bearbeiten Sie ein Ereignis"; break;
   ...
   case "Etes-vous certain de vouloir supprimer cet évènement": $tmp = "Sind Sie sicher, dass Sie dieses Ereignis zu löschen?"; break;
   case "Etre averti par mail d'un nouvel evenement": $tmp = "Being per E-Mail an neue Ereignisse informiert"; break;
   case "Evènement": $tmp = "Ereignis"; break;
   case "Evènement(s) à venir": $tmp = "Die nächsten Veranstaltung"; break;
   case "Evènement(s) en cours ou passé(s)": $tmp = "aktuelle Ereignisse oder Vergangenheit"; break;
   case "Evènement nouveau dans agenda": $tmp = "neue Ereignisse in Kalender"; break;
   ...
   case "Jour avec évènement(s)": $tmp = "Day-Event mit"; break;
   ...
   case "Liste des évènements": $tmp = "Liste der Veranstaltungen"; break;
   case "Liste de vos évènements": $tmp = "Listen Sie Ihre Veranstaltungen"; break;
   ...
   case "Mai": $tmp = "Mai"; break;
   case "Mail du receveur": $tmp = "Mail-Empfänger"; break;
   ...
   case "Modification évènement pour agenda": $tmp = "Veranstaltung Agenda für den Wandel"; break;
   case "Modifier l'Evènement": $tmp = "Ereignis bearbeiten"; break;
   case "Modifier la catégorie": $tmp = "Kategorie wechseln"; break;
   case "Nbre d'évènements (pagination)": $tmp = "Anzahl der Ereignisse"; break;
   case "Dans la partie module": $tmp = "Im Modulteil"; break;
   case "Dans la partie admin": $tmp = "In Teil Verwaltung"; break;
   ...
   case "Proposer évènement": $tmp = "Senden einer Veranstaltung"; break;
   case "Proposer un évènement": $tmp = "Senden einer Veranstaltung"; break;
   ...
   case "Résumé de l'évènement": $tmp = "Ereignis-Übersicht"; break;
   ...
   case "Sélectionner si nécessaire": $tmp = "Wählen Sie bei Bedarf"; break;
   ...
   case "Supprimer cet évènement": $tmp = "Dieses Ereignis löschen"; break;
   ...
   case "Un évènement nouveau est à valider dans agenda": $tmp = "Ein neues Ereignis ist in der Tagesordnung zur Validierung"; break;
   case "V": $tmp = "F"; break;
