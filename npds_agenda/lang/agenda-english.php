...
//   case "Champ obligatoire": $tmp = "Mandatory field"; break;
   ...
   case "Etes-vous certain de vouloir supprimer cet évènement": $tmp = "Are you sure you want to delete this event?"; break;
   case "Etre averti par mail d'un nouvel evenement": $tmp = "Being informed by mail of a new event"; break;
   case "Evènement": $tmp = "Event"; break;
   case "Evènement(s) à venir": $tmp = "Upcoming events"; break;
   case "Evènement(s) en cours ou passé(s)": $tmp = "Events in current or past"; break;
   case "Evènement nouveau dans agenda": $tmp = "New event in calendar"; break;
   ...
   case "Jour avec évènement(s)": $tmp = "Day with event(s)"; break;
   ...
   case "Nbre d'évènements (pagination)": $tmp = "Number of events (pagination)"; break;
   case "Dans la partie module": $tmp = "In the module part"; break;
   case "Dans la partie admin": $tmp = "In the admin part"; break;
   ...
   case "Proposer évènement": $tmp = "Submit event"; break;
   case "Proposer un évènement": $tmp = "Submit an event"; break;
   ...
   case "Sélectionner si nécessaire": $tmp = "Select if required"; break;
   ...
   case "Supprimer cet évènement": $tmp = "Delete this event"; break;
