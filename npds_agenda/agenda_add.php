...
function cal($month, $an, $debut)
{
   ...
   for ($i = 1; $i < 8; $i++)
   {
      ...
      else
      {
         ...
         {
            echo '<td data-toggle="tooltip" data-placement="bottom" title="Réservée" class="text-center font-weight-bold alert alert-info">'.$ce_jour.'</td>';
         }
      }
   }
...
// Fin securite
   ...
   <label class="mr-sm-2" for=""><strong>'.ag_translate('Catégorie').'</strong><span class="text-danger ml-2"><i class="fa fa-asterisk" aria-hidden="true"></i></span></label>
