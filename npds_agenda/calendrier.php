  ...
  <div class="modal-dialog modal-lg"" role="document">
    <div class="modal-content">
      ...
      <h5 class="'.$etat.'"><strong>';
				if ($tot > 1)
				{
	  $affres .= ag_translate('Les').' '.$datepourmonmodal;
				}
				else{
	  $affres .= ag_translate('Le').' '.$newdate;
...
//Pour la naviguation
	...
	if ($nb_entrees == 0)
	{
		$affeven = '<p>'.ag_translate('Rien de prévu ce jour').'</p>';
	}
	else
	{
...
/*Si evenement plusieurs jours*/
				...
				$affeven .= '<img class="img-thumbnail" src="'.$tipath.''.$topicimage.'" />';
				...
				else
				{
				    ...
				    $affeven .= '<div class="'.$etat.' mr-2 mb-2">ttt'.$newdate.'</div>';
				}
