...
/* ==========================                */
/* Fichier : modules/agenda/ag_fonc.php      */
/*                                           */
/* Module Agenda                             */
/* Version 1.0                               */
/* Auteur Oim                                */
...
/* pour avoir tous les jours fériés de l'annee,
...
// Quelques fêtes mobiles
	...
	$lundi_de_paques['nom'] = ag_trad('Lundi de Pâques');
	$ascencion['mois'] = date( "n", easter_date2($an)+39*$jour);
	$ascencion['jour'] = date( "j", easter_date2($an)+39*$jour);
	$ascencion['nom'] = ag_trad('Jeudi de l\'ascension');
	$vendredi_saint['mois'] = date( "n", easter_date2($an)-2*$jour);
	$vendredi_saint['jour'] = date( "j", easter_date2($an)-2*$jour);
	$vendredi_saint['nom'] = ag_trad('Vendredi Saint');
	$lundi_de_pentecote['mois'] = date( "n", easter_date2($an)+50*$jour);
	$lundi_de_pentecote['jour'] = date( "j", easter_date2($an)+50*$jour);
	$lundi_de_pentecote['nom'] = ag_trad('Lundi de Pentecôte');

// France
	$ferie[ag_trad('Jour de l\'an')][1] = 1;
	$ferie[ag_trad('Armistice 39-45')][5] = 8;
	$ferie[ag_trad('Toussaint')][11] = 1;
	$ferie[ag_trad('Armistice 14-18')][11] = 11;
	$ferie[ag_trad('Assomption')][8] =15;
	$ferie[ag_trad('Fête du travail')][5] =1;
	$ferie[ag_trad('Fête nationale')][7] =14;
	$ferie[ag_trad('Noël')][12] = 25;
