...
//$PAGES['modules.php?ModPath='.$ModPath.'&ModStart=index*']['blocs']="2";
...
//$PAGES['modules.php?ModPath='.$ModPath.'&ModStart=list_ann*']['blocs']="2";
...
//$PAGES['modules.php?ModPath='.$ModPath.'&ModStart=annonce_form*']['blocs']="2";
...
//$PAGES['modules.php?ModPath='.$ModPath.'&ModStart=modif_ann*']['blocs']="2";
$PAGES['modules.php?ModPath='.$ModPath.'&ModStart=modif_ann*']['TinyMce']=1;
$PAGES['modules.php?ModPath='.$ModPath.'&ModStart=modif_ann*']['TinyMce-theme']="full";
...
//$PAGES['modules.php?ModPath='.$ModPath.'&ModStart=admin*']['blocs']="2";
