...
function AfficheHaut($ModPath, $ModStart) {
   ...
   if ($result) {
      ...
      echo '<p class="lead"><i class="fa fa-info-circle" aria-hidden="true"></i> <span class="badge badge-default">'.$nombre.'</span> '.encap_translate("encapsulation(s) dans la table").'</p>';
      echo '<p class="lead">'.encap_translate("Pour modifier un enregistrement, cliquez sur son nom").'</p>';
...
function AddEditBas($ModPath, $ModStart, $subop){
   ...
   if ($subop=="addform"){
      echo '<p class="lead"><i class="fa fa-plus" aria-hidden="true"></i> '.encap_translate("Ajouter un enregistrement").'</p>';
...
echo '<div class="form-group row">
    <label for="" class="col-3 col-form-label"><strong>'.encap_translate("Nom").'</strong></label>
    <div class="col-9">
...
echo '<div class="form-group row">
      <label for="" class="col-3 col-form-label"><strong>'.encap_translate("Display").'</strong></label>
      <div class="col-3">';
...
echo '<div class="form-group row">
      <label for="" class="col-3 col-form-label"><strong>'.encap_translate("Type").'</strong></label>
      <div class="col-4">';
...
echo '<div class="form-group row">
      <label for="" class="col-3 col-form-label"><strong>'.encap_translate("Forme").'</strong></label>
      <div class="col-4">';
...
echo '<div class="form-group row">
         <label for="" class="col-3 col-form-label"><strong>'.encap_translate("Adresse").'</strong></label>
         <div class="col-9">
...
echo '<div class="form-group row">
         <label for="" class="col-3 col-form-label"><strong>'.encap_translate("Hauteur").'</strong></label>
         <div class="col-3">
...
echo '<div class="form-group row">
      <label for="" class="col-3 col-form-label"><strong>'.encap_translate("Scroll").'</strong></label>
      <div class="col-4">';

echo "<select name=\"scroll\" class=\"form-control\">
         <option value=\"non\"";
...
echo '<div class="form-group row">
      <label for="" class="col-3 col-form-label"><strong>'.encap_translate("Bloc").'</strong></label>
      <div class="col-3">';
...
echo '<button type="button" class="btn btn-outline-info btn-sm mt-1" data-toggle="modal" data-target="#bd-conf">'.encap_translate("Aide").'</button>
...
echo '<div class="form-group row">
      <label for="" class="col-3 col-form-label"><strong>'.encap_translate("Titre").'</strong></label>
      <div class="col-sm-9">
...
echo '<div class="form-group row">
      <label for="" class="col-3 col-form-label"><strong>'.encap_translate("Affichage du titre").'</strong></label>
      <div class="col-3">';
echo "<select name=\"tit\" class=\"form-control\">
         <option value=\"1\"";
...
echo '</div></div>';
echo '<button type="submit" class="btn btn-outline-primary btn-sm mr-2" name="valider" value="'.encap_translate("Enregistrer").'" ><i class="fa fa-check" aria-hidden="true"></i> '.encap_translate("Enregistrer").'</button>';
echo '<a class="btn btn-outline-danger btn-sm" href="'.$ThisFile.'">'.encap_translate("Annuler").'</a>';
echo '</form>';
echo '</div>';
}
...
function AccAdd($nom,$display,$type,$form,$adresse,$height,$scroll,$block,$tit,$titre){
   ...
   if ($nom!="") {
      ...
      if ($num = sql_num_rows(sql_query($verif))) {
         echo '<p class="lead text-danger"><i class="fa fa-info-circle" aria-hidden="true"></i> '.encap_translate("Le nom saisi existe déjà").'</p>';
      } else {
        ...
        $result = sql_query($sql);
        echo '<p class="lead"><i class="fa fa-info-circle" aria-hidden="true"></i> '.encap_translate("Enregistrement effectué").'</p>';
      }
...
function AccEdit($id,$nom,$display,$type,$form,$adresse,$height,$scroll,$block,$tit,$titre){
   ...
   if($result = sql_query($sql)){   
      echo '<p class="lead"><i class="fa fa-info-circle" aria-hidden="true"></i> '.encap_translate("Mise à Jour effectuée").'</p>';
        }
        else{
      echo '<p class="lead text-danger"><i class="fa fa-info-circle" aria-hidden="true"></i> '.encap_translate("Mise à Jour non effectuée").'</p>';
   }
}
...
function Accdelete($id){
   ...
   if ($result = sql_query($sql)) {
      echo '<p class="lead"><i class="fa fa-info-circle" aria-hidden="true"></i> '.encap_translate("Enregistrement N°").' '.$id.' '.encap_translate("effacé").'</p>';
   } else {
      echo '<p class="lead text-danger"><i class="fa fa-info-circle" aria-hidden="true"></i> '.encap_translate("Erreur de suppression de l'enregistrement N°").' '.$id.'</p>';
   }
}
...
function Acclink($nom){
   ...
   if ($result = sql_query($sql)) {
      echo '<p class="lead"><i class="fa fa-info-circle" aria-hidden="true"></i> '.encap_translate("Le lien de votre page encapsulée est").' :</p>';
      ...
      echo '<p class="lead text-danger"><i class="fa fa-info-circle" aria-hidden="true"></i> '.encap_translate("Le lien n'existe pas").'</p>';
   }
}
