...
function AfficheHaut($ModPath, $ModStart) {
   ...
   $version = 'V.5.0';
   echo '<h2><img class="" src="modules/npds_encapsuleur/npds_encapsuleur.png" alt="icon_npds_encapsuleur"> '.encap_translate('Encapsuleur').'<small class="float-right">'.$version.'</small></h2>';
...
echo '<div class="card mb-2"><div class="card-block">';
...
echo '<div class="form-group row">
      ...
      <div class="col-sm-3">';
echo '<select name="display" class="custom-select">
         <option value="1"';
...
echo '<div class="form-group row">
      ...
      <div class="col-sm-4">';
echo '<select name="form" class="custom-select">
         <option value="http"';
...
echo '<div class="form-group row">
      ...
      <div class="col-sm-4">';
echo '<select name="scroll" class="custom-select">
         <option value="non"';
...
echo '<div class="form-group row">
      ...
      <div class="col-sm-3">';
echo '<select name="block" class="custom-select">
         <option value="0"';
...
echo '<div><button type="button" class="btn btn-outline-info btn-sm mt-2" data-toggle="modal" data-target="#bd-conf">'.encap_translate("Aide").'</button></div>
