...
/*Fin Securite*/
echo '<link href="themes/infocapagde-2011/style/style.css" rel="stylesheet" type="text/css">';
...
//si le fichier n'est pas un répertoire
	...
	{
	echo '<h5 align="center">S&eacute;lectionner sur votre ordinateur le fichier image .jpg à redimensionner <i>(3000 Ko max.)</i></h5>';
	}
...
//fonction de redimensionnement de l'image
	...
	if ($choix =="Mini deux photos cote à cote")
	{
	$dst_w = 250;
	$dst_h = 188;
	}
	...
	elseif ($choix =="Calibrage spécial albums Blog")
	{
	$dst_w = 567;
	$dst_h = 425;
	}
...
// destruction des images temporaires
	...
	echo '<form enctype="multipart/form-data" action="modules.php?ModPath=photosize&amp;ModStart=photosizef" method="post">'
	...
	.'<option>Mini deux photos cote à cote</option>'
	.'<option>Avatar</option>'
	.'<option>Calibrage spécial albums Blog</option>'
	.'</select><br /><br /></td>'
	.'</tr>'
	.'<tr>'
	.'<td align="center"><input  class="bouton_standard" type="submit" value="Redimensionner la photo" /></td>'
	.'</tr>'
	.'</table>'
	.'</form>';
	echo '<p align="center">Choisir <b>Normal</b> pour une photo illustrant article<br />Choisir <b>Mini</b> pour mettre dans un tableau de deux images cote à cote ou quatre images en carré.<br />Choisir <b>Avatar</b> pour calibrer la photo de votre Avatar dans votre profil</p>';
